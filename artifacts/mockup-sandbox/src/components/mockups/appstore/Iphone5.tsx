            ...
            <div className="absolute inset-[12px] rounded-[48px] overflow-hidden bg-[#0A1628]">
              ...
              <div className="px-6 py-5 bg-gradient-to-b from-amber-900/20 to-transparent border-b border-[#1a2f4a]">
                <div className="flex items-center justify-between mb-2">
                  <h2 className="text-white font-black text-3xl">Veckans Cup</h2>
                  <div className="px-3 py-1 bg-amber-500/20 border border-amber-500/50 rounded-full">
                    <span className="text-amber-400 font-bold text-xs uppercase tracking-wider">Live nu</span>
                  </div>
                </div>
                <p className="text-gray-400 text-sm">Kvartsfinaler pågår</p>
              </div>
              ...
              <div className="mx-6 mt-6 p-4 rounded-xl bg-gradient-to-r from-amber-500 to-orange-600 flex items-center justify-between shadow-lg shadow-amber-600/20">
                <div>
                  <div className="text-amber-100 text-xs font-bold uppercase tracking-wider mb-1">Prispott</div>
                  <div className="text-white font-black text-2xl">5,000 Mynt</div>
                </div>
              ...
              <div className="px-6 py-8">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-white font-black text-xl">Slutspelsträd</h3>
                ...
                <div className="relative">
                    ...
                    <div className="flex flex-col gap-2">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <div className="w-6 h-6 rounded-full bg-gradient-to-br from-emerald-400 to-teal-600 flex items-center justify-center text-white font-bold text-xs">D</div>
                          <span className="text-white font-bold text-sm">Du</span>
                        </div>
                        <span className="text-emerald-400 font-black text-sm">Vinst</span>
                      </div>
                      ...
                      <div className="flex items-center justify-between opacity-50">
                        ...
                        <span className="text-gray-400 font-black text-sm">Förlust</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="absolute top-1/2 right-0 -translate-y-1/2 z-10 bg-gradient-to-r from-amber-500/10 to-orange-600/10 border-2 border-amber-500/50 rounded-xl p-3 w-[45%] shadow-lg shadow-amber-500/20">
                    ...
                    <div className="flex flex-col gap-2 mt-1">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <div className="w-6 h-6 rounded-full bg-gradient-to-br from-emerald-400 to-teal-600 flex items-center justify-center text-white font-bold text-xs border border-amber-400">D</div>
                          <span className="text-white font-bold text-sm">Du</span>
                        </div>
              ...
              <div className="px-6 mt-4">
                <div className="bg-[#0d1d35]/80 backdrop-blur-xl border border-amber-500/30 rounded-2xl p-5 text-center">
                  ...
                  <h4 className="text-white font-bold text-lg mb-1">Finalen börjar snart</h4>
                  <p className="text-gray-400 text-sm mb-4">Gör dig redo för din nästa match mot Kapten_Erik.</p>
