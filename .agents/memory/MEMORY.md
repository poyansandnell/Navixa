...
- [Apple review compliance](apple-review-compliance.md) — deletion order (DB→Clerk), transactional block invariants, ban enforcement in requireAuth, terms links, Review Test Player seed, API-based git push.
