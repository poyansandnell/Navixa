---
name: Supabase setup for Navixa
...
- Client config: `EXPO_PUBLIC_SUPABASE_URL` (shared env var) + `EXPO_PUBLIC_SUPABASE_ANON_KEY` (Replit Secret). Expo client at `artifacts/navixa/lib/supabase.ts`.
